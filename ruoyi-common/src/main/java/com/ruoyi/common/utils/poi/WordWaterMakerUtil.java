...
/**
 * @ClassName WordWaterMakerUtil
 * @Description TODO
 * @Author yangHui
 * @Date 2020/9/12 10:04
 * @Version 1.0
 */
public class WordWaterMakerUtil {
    ...
    public WordWaterMakerUtil(String customText) {
...
//            return;
//        }
        //(BufferedInputStream buffIn = new BufferedInputStream(Files.newInputStream(tempFile)))
        try {
            XWPFDocument doc = loadDocXDocument(filePath);
            if (doc == null) {
                return;
            }
            // 遍历文档，添加水印
    ...
    /**
     * 为文档添加水印<br />
     * 实现参考了{org.apache.poi.xwpf.model.XWPFHeaderFooterPolicy#getWatermarkParagraph(String, int)}
     *
    ...
    // 加载docx格式的word文档
    private XWPFDocument loadDocXDocument(String filePath) {
        XWPFDocument doc;
        try {
